...
//    private List<String> specialite;
    ...
    public UserInfoResponse(Long id, String telephone, String email, String nom, String prenom, String genre, TypeAuditeur typeAuditeur,Date date, List<String> roles, String accessToken) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
...
//    }
    ...
    public TypeAuditeur getSpecialite() {
        return typeAuditeur;
    }

    public void setSpecialite(TypeAuditeur typeAuditeur) {
        this.typeAuditeur = typeAuditeur;
    }
