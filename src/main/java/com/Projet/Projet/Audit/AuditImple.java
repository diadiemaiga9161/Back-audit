...
public class AuditImple implements AuditService{
    ...
    @Override
    public MessageResponse Supprimer(Long id_Audit) {
        return null;
    }
    ...
    public Object Ajouter(Audit audit) {
        ...
        return new MessageResponse("Audit ajouté avec succès", true);
...
//        }
    ...
    @Override
    public MessageResponse modifierAudit(Long id, String tauxconformite,String datedebut,String datefin, Long conformite) {
        return null;
    }
}
